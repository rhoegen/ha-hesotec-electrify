"""Switch platform for hesotec_electrify."""
...
class HesotecElectrifySwitch(HesotecElectrifyEntity, SwitchEntity):
    """hesotec_electrify switch class."""
